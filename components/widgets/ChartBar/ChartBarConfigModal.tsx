...
export const ChartBarConfigModal = ({
  ...
  const getModeDescription = (mode: string) => {
    switch (mode) {
      case "single":
        return "Single bars for each data source";
      case "stacked":
        return "Bars stacked on top of each other";
      case "grouped":
        return "Bars grouped side by side";
      default:
        return "";
    }
  };
      ...
      <DialogContent className="sm:max-w-4xl max-h-[90vh] overflow-y-auto auto-hide-scrollbar">
          ...
          <div className="flex items-start justify-between">
            <div className="flex-1">
              ...
              <DialogDescription className="mt-1">
                Configure a bar chart to visualize data comparisons across
                multiple sources with various display options.
              </DialogDescription>
            </div>
              ...
              <PopoverContent className="w-80" align="end">
                <div className="space-y-2">
                  ...
                  <div className="text-sm text-muted-foreground space-y-1">
                    ...
                    <div>
                      <strong>Colors:</strong> {colorScheme}
                    </div>
                    <div>
                      <strong>Values:</strong> {showValues ? "Shown" : "Hidden"}
                    </div>
                    <div>
                      <strong>Grid:</strong> {showGrid ? "Shown" : "Hidden"}
                    </div>
                  </div>
                </div>
              </PopoverContent>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 p-6">
          ...
          <div className="space-y-4">
            ...
            <div className="grid gap-2">
              <Label>
                Selected Data Sources ({selectedConfigNames.length}/8)
              </Label>
