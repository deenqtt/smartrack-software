          ...
          <div className="flex items-start justify-between">
            <div className="flex-1">
              <DialogTitle className="text-xl">
                {isEditMode
                  ? "Edit Power Generation Chart"
                  : "Configure Power Generation Chart"}
              </DialogTitle>
              <DialogDescription className="mt-1">
                Configure power generation monitoring with real-time data
                visualization and customizable display options.
              </DialogDescription>
            </div>
                ...
                <div className="space-y-2">
                  ...
                  <div className="text-sm text-muted-foreground space-y-1">
                    ...
                    <div>
                      ...
                      {selectedConfigNames.length} selected
                    </div>
                    <div>
            ...
            <div className="grid gap-2">
              ...
              <Select onValueChange={handleAddConfig} disabled={isLoading}>
                <SelectTrigger>
                  <SelectValue
                    placeholder={
                      isLoading ? "Loading configs..." : "Select data sources"
                    }
                  />
                </SelectTrigger>
                <SelectContent>
                  {loggingConfigs
                    .filter(
                      (config) =>
                        !selectedConfigNames.includes(config.customName),
                    )
                    .map((config) => (
