...
export const PowerAnalysisChartConfigModal = ({
  isOpen,
  onClose,
  onSave,
  initialConfig,
          ...
          <div className="flex items-start justify-between">
            <div className="flex-1">
              <DialogTitle className="text-xl">
                {isEditMode ? "Edit Power Analysis Chart" : "Configure Power Analysis Chart"}
              </DialogTitle>
              <DialogDescription className="mt-1">
                Configure power quality analysis with harmonics detection and electrical parameter monitoring.
              </DialogDescription>
            </div>
              ...
              <PopoverContent className="w-80" align="end">
                <div className="space-y-2">
                  ...
                  <div className="text-sm text-muted-foreground space-y-1">
                    ...
                    <div><strong>Harmonics:</strong> {showHarmonics ? "Enabled" : "Disabled"}</div>
                    <div><strong>Quality Metrics:</strong> {showQualityMetrics ? "Enabled" : "Disabled"}</div>
