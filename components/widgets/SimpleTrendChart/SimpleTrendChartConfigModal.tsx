...
export const SimpleTrendChartConfigModal = ({
  isOpen,
  onClose,
  onSave,
  initialConfig,
      ...
      <DialogContent className="sm:max-w-4xl">
        <DialogHeader className="px-6 pt-6">
          <DialogTitle className="text-xl">
            {isEditMode ? "Edit Simple Trend Chart" : "Configure Simple Trend Chart"}
          </DialogTitle>
          <DialogDescription>
            Configure a simple trend chart to display KPI metrics and trend analysis for a single data source.
          </DialogDescription>
        </DialogHeader>
            ...
            <div className="grid gap-2">
              ...
              <div className="flex items-center gap-2">
                <Input
                  ...
                  className="w-16 h-10"
                />
                <span className="text-sm text-muted-foreground">{chartColor}</span>
              </div>
            </div>
          </div>
